...
- [x] Create index.html with heading, textarea, button, and four result boxes
- [x] Create style.css for simple, clean styling
- [x] Create app.js with fetch logic to send code to backend and display results
